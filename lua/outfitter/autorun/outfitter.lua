...
Core64.GitRunSH("lua/outfitter/includes/modules/gmaparse.lua")
Core64.GitRunSH("lua/outfitter/includes/modules/mdlinspect.lua")
Core64.GitRunSH("lua/outfitter/includes/modules/co.lua")
...
local function inc(str)
	return function(m)
		...
		if m == 'sh'
			...
			or (C and m=='cl')
		then
			Core64.GitRunSH("lua/outfitter/"..path)
		end
	end
end
